...
export const PartnerRow: React.FC<PartnerRowProps> = ({ partners }) => {
  return (
    <div className="space-y-6 py-10">
      <h2 className="text-lg md:text-xl font-semibold text-[#e5e5e5] tracking-wide px-1">
      ...
      <div className="flex flex-wrap gap-x-12 gap-y-8 items-center justify-start">
        {partners.map((partner, index) => (
          ...
          >
            ...
            {/* Netflix-style Tooltip (Vyskočí při najetí) */}
            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-4 w-64 p-4 bg-[#181818] border border-neutral-800 rounded-md shadow-2xl opacity-0 group-hover:opacity-100 pointer-events-none transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 z-50">
              <div className="flex flex-col gap-1">
                <span className="text-[#E50914] font-bold text-[10px] uppercase tracking-wider">
                  Spolupráce
                </span>
