...
// Pomocná funkce pro YouTube ID - důležitá pro mřížku médií
...
const ptComponents = {
  ...
  types: {
    ...
    // PŘIDÁNO: Funkční Mřížka pro videa a fotky vedle sebe
    mediaGrid: ({ value }: any) => {
  ...
  block: {
    // ZACHOVÁNO: Zarovnání textu k okraji fotky
